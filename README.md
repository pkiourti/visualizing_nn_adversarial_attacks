...
- [Setup](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/blob/main/README.md#setup)
  - [Install dependencies from requirements.txt](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#install-dependencies-from-requirementstxt)
  - [Install MongoDB on Ubuntu](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#install-mongodb-on-ubuntu)
  - [Install and start ngrok](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#install-and-start-ngrok)
  - [Install dependencies for React](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#install-dependencies-for-react)
  - [Start MongoDB](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#start-mongodb)
  - [Prepare Database](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#prepare-database)
  - [Start the Flask Server](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#start-the-flask-server)
  - [Start the application](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#start-the-application)
- [Notes](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#notes)
  - [Onnx](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#onnx)
  - [Sending images from Flask to React](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#sending-images-from-flask-to-react)
  - [Uploading a model to the server](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#uploading-a-model-to-the-server)
- [Database Schema](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#database-schema)
- [Screenshots of the application](https://github.com/pkiourti/visualizing_nn_adversarial_attacks/edit/main/README.md#screenshots-of-the-application)
